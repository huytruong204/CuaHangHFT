                                ...
                                (function() {
                                    ...
                                    function setRating(v) {
                                        ...
                                        stars.forEach(function(s) {
                                            ...
                                            if (val <= v) s.classList.add('filled');
                                    ...
                                    stars.forEach(function(s) {
                                        s.addEventListener('mouseover', function() {
                                            ...
                                            stars.forEach(function(x) {
                                                if (parseInt(x.getAttribute('data-value'), 10) <= v) x.classList.add('hovered');
                                                else x.classList.remove('hovered');
                                            });
                                        });
                                    ...
                                    <?php if (!empty($mode) && $mode === 'edit' && !empty($review)): ?>
                                            (function() {
                                                ...
                                                if (rev.rating) {
                                                    setRating(parseInt(rev.rating, 10));
                                                }
                                                var ta2 = document.getElementById('review_comment');
                                                if (ta2) ta2.value = rev.comment || '';
