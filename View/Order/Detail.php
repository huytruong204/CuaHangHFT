<div class="container mt-20 mb-30">
    ...
    <?php else: ?>
        ...
        <div class="row">
                        ...
                        <table class="table table-hover table-no-margin">
                            ...
                            <tfoot>
                                <tr class="tr-bg-contrast">
                                    <td colspan="3" class="text-right border-top-2" style="vertical-align: middle;">
                                        <span style="font-size: 16px; font-weight: bold; color: #555;">TỔNG CỘNG:</span>
                                    </td>

                                    <td class="text-right border-top-2" style="vertical-align: middle;">
                                        <span class="text-orange" style="font-size: 24px; font-weight: bold;">
            ...
            <div class="col-md-12 bg" style="margin-top: 20px;">
